<?php
	...
	$gestioneMaestriClick=base_url()."index.php/gestioneMaestri/show";
?>
<nav style="margin: 0; border: 0; padding:0;" class="navbar nav-pills nav-stacked col-md-3" role="navigation">
	<div style="/*height: 94%; background-color:#85FFAD;*/ text-align: center; color: white;" class="col-md-12"></br>
		...
		<button type="button" class="btn btn-primary btn-lg btn-block" onclick="window.location=('<?php echo($gestioneMaestriClick) ?>');">Gestione Maestri</button></br>
